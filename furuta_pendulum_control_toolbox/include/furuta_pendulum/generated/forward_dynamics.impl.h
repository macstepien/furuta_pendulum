...
template <typename TRAIT>
iit::FurutaPendulum::dyn::tpl::ForwardDynamics<TRAIT>::ForwardDynamics(
  iit::FurutaPendulum::dyn::tpl::InertiaProperties<TRAIT> & inertia, MTransforms & transforms)
: inertiaProps(&inertia), motionTransforms(&transforms)
{
  arm1_v.setZero();
  arm1_c.setZero();
  arm2_v.setZero();
...
void iit::FurutaPendulum::dyn::tpl::ForwardDynamics<TRAIT>::fd(
  JointState & qdd, const JointState & qd, const JointState & tau,
  const ExtForces & fext /* = zeroExtForces */)
{
  ...
  iit::rbd::compute_Ia_revolute(
    arm2_AI, arm2_U, arm2_D,
    Ia_r);  // same as: Ia_r = arm2_AI - arm2_U/arm2_D * arm2_U.transpose();
