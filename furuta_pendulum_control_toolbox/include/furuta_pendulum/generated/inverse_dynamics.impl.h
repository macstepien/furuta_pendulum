...
template <typename TRAIT>
iit::FurutaPendulum::dyn::tpl::InverseDynamics<TRAIT>::InverseDynamics(
  IProperties & inertia, MTransforms & transforms)
...
void iit::FurutaPendulum::dyn::tpl::InverseDynamics<TRAIT>::id(
  JointState & jForces, const JointState & qd, const JointState & qdd, const ExtForces & fext)
{
...
template <typename TRAIT>
void iit::FurutaPendulum::dyn::tpl::InverseDynamics<TRAIT>::C_terms(
  JointState & jForces, const JointState & qd)
{
  // Link 'arm1'
...
template <typename TRAIT>
void iit::FurutaPendulum::dyn::tpl::InverseDynamics<TRAIT>::firstPass(
